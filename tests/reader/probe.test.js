...
const auth = fs.readFileSync(path.join(__dirname, '../../reader/auth.js'), 'utf8');
const appSource = fs.readFileSync(path.join(__dirname, '../../reader/app.js'), 'utf8').replace('./auth.js', 'data:text/javascript;base64,' + Buffer.from(auth).toString('base64'));
